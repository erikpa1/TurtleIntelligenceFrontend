export default function IconFolderIcon({
                                           color = "#666666",
                                           width = 24,
                                           height = 24,
                                       }) {
