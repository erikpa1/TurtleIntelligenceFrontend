...
import ShelfScene from "@TurtleSim/Fibers/ShelfFiber";
...
export default function SimWorldDock({}) {
    ...
    return <_LayoutDock key={world.uid} world={world} />;
}
        ...
        <div>
            ...
            >
                ...
                <Splitter.Panel defaultSize="60%">
                    ...
                    {activeMid === "world" && <_WorldDock world={world} />}

                    {activeMid === "statistics" && <SimStatisticsView />}
                </Splitter.Panel>
