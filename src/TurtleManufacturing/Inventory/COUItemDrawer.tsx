...
import Item, {
    ...
    ITEM_UOMS,
    PROCUREMENT_TYPES,
} from "@TurtleManufacturing/Data/Item";
...
export default function COUItemDrawer({
    open,
    item,
    onClose,
    onSaved,
    ...
    async function submit() {
        ...
        try {
            ...
            message.success(
                t(isEdit ? "Material updated" : "Material created"),
            );
            onSaved();
            onClose();
        } finally {
                ...
                <Row gutter={12}>
                    <Col span={12}>
                        <Form.Item
                            ...
                            tooltip={t(
                                "Make = produced via BOM, Buy = purchased externally",
                            )}
                        >
                            <Select
                ...
                <Row gutter={12}>
                    ...
                    <Col span={8}>
                        <Form.Item
                            ...
                            label={t("Lot size")}
                            tooltip={t(
                                "0 = lot-for-lot (order exact net requirement)",
                            )}
                        >
                            <InputNumber style={{ width: "100%" }} min={0} />
                        </Form.Item>
